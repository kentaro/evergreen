...
type EmptyGif struct{}

var contentType = "image/gif"
var contentLength = "43"
...
func (self *EmptyGif) Set(writer http.ResponseWriter) {
	writer.Header().Set("Content-Type", contentType)
	writer.Header().Set("Content-Length", contentLength)
	writer.Write(self.newEmptyGif())
}

func (self *EmptyGif) newEmptyGif() (result []byte) {
	return emptyGif
}
